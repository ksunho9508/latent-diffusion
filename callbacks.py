...
class ImageLogger(Callback):
    def __init__(self, batch_frequency, max_images, clamp=True, increase_log_steps=True,
                 ...
                 log_images_kwargs=None, valtest_batch_frequency=None):
        super().__init__()
        self.rescale = rescale
        self.batch_freq = batch_frequency
        self.valtest_batch_frequency = valtest_batch_frequency
    ...
    def check_frequency(self, check_idx, split=None):
        if split == 'train':
            ...
            if ((check_idx % self.valtest_batch_frequency) == 0 or (check_idx in self.log_steps)) and (
                    check_idx > 0 or self.log_first_step):
                try:
                    self.log_steps.pop(0)
                except IndexError as e:
